...
public class MigratorConfiguration {
    ...
    @Valid
    @NotNull
    @JsonProperty ("writerMaxBatchSize")
    private Optional<Integer> _writerMaxBatchSize = Optional.absent();
    ...
    public Optional<Integer> getWriterMaxBatchSize() {
        return _writerMaxBatchSize;
    }
}
